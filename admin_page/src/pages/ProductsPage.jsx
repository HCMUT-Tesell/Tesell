  ...
  return (
    <div className='flex flex-col gap-10'>
        ...
        <div className='flex justify-between pt-5 gap-5'>
            ...
            {
            addingProduct ? <div className='relative box-border bg-[#E8F3FB] border border-[#127CC5] rounded-[20px] flex flex-col justify-between items-center mr-60 mb-5'>
            ...
            <form action="post" onSubmit={handleAddSubmit} className='flex flex-row justify-center gap-3'>
        ...
        : editingProduct ? 
         ...
         <form action="put" onSubmit={handleEditSubmit} className='flex flex-row justify-center gap-3'>
             <div className='flex flex-col gap-2 pb-8 pl-8'>
