...
const OrderCard = ({dateOrdered, status, orderId, totalPrice, images, user, firstName, lastName, shippingAddress, phone}) => {
    ...
    return (
        <div className='w-3/4 h-fit p-5 bg-blue-50 rounded-lg'>
            {/* Ngày đặt ------ Trạng thái */}
            ...
            {/* Địa chỉ ------- SĐT */}
            <div className='mb-2 flex flex-row justify-between gap-5 overflow-hidden'>
                <div className='flex flex-row gap-2'>
                    <div>Địa chỉ:</div>
                    <div className='font-bold'>{shippingAddress}</div>
                </div>
