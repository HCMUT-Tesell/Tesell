...
const Banner = () => {
    return (
      ...
      <Carousel slideInterval={3000} pauseOnHover className="h-[380px]">
        <img className="h-full rounded-xl" src={banner2} alt="..." />
        <img className="h-full rounded-xl" src={banner3} alt="..." />
        <img className="h-full rounded-xl" src={banner4} alt="..." />
        <img className="h-full rounded-xl" src={banner1} alt="..." />
        <img className="h-full rounded-xl" src={banner3} alt="..." />       
      </Carousel>
      <Carousel slideInterval={3000} pauseOnHover className="h-[380px]" >
        ...
        <img className="h-full rounded-xl" src={banner14} alt="..." />
