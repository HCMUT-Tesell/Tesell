...
const PurchaseHistoryDetail = () => {
    ...
    // useEffect(() => {
    //     if (productInfo) setIsLoading(true);
    // }, [productInfo])
            ...
            <div className='flex flex-col gap-3 items-center mb-5'>
                ...
                <div className='bg-gray-200 p-5 static flex flex-col gap-3 items-center justify-center rounded-lg w-3/4'>
                    ...
                    <div className='flex flex-col gap-2 w-full bg-white rounded-md p-5'>
                        {productInfo.map((product, index) => {return (
                            <ProductCard key={index} productName={product[0].productName} imageUrl={product[0].imageUrl} quantity={product[1]} sellPrice={product[0].sellPrice}/>
                        )})}
                    ...
                    <div className='w-full mb-2 flex flex-row justify-between'>
                        <div>Tiền hàng:</div>
                        <div className='font-semibold text-lg'>{formatCurrency(order.totalPrice - 50000)}</div>
                    </div>
                    ...
                    <div className='w-full mb-2 flex flex-row justify-between'>
                        ...
                        <div className='font-bold text-xl'>{formatCurrency(order.totalPrice)}</div>
                    </div>
                </div>
