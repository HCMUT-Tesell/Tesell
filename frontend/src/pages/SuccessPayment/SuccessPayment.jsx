    ...
    return (
        <div className="flex flex-col justify-center items-center">
            ...
            <div className='flex justify-center mt-10'>
                <button onClick={() => navigate(`/PurchaseHistory/${orderId}`)} className='bg-gray-200 border-gray-400 border-2 font-semibold py-2 px-6 rounded-lg shadow-lg hover:bg-gray-300 hover:shadow-xl mr-6'>
